...
- **Q-A:** Do CVM top-quartile firms deliver higher risk-adjusted forward returns than bottom-quartile firms over 2013–2023, after controlling for sector, country, size, beta, and regime?
- **Q-B:** Are the proposed CVM layer weights consistent with the empirical principal components of firm-level scores across a 200-firm sample over 2013–2023?
...
200 publicly listed firms (S&P top 100, EuroStoxx + UK top 50, Nikkei top 20, APAC ex-Japan top 30) × 44 quarter-ends (2013-Q1 through 2023-Q4) = up to **8,800 firm-quarter observations**. Effective sample after NA-dropping on regression inputs typically ~6,500–7,500.
...
- **SimFin coverage.** Free tier is US-strong; EU and APAC coverage varies. The analysis gracefully handles missing data, but effective sample for non-US firms may be ~60–80% of nominal. The 12-month publish delay on the free tier means our most recent data point is 2023-Q4.
