...
SECTOR_BASELINES = {
    "TECH": {
        ...
        "dims": {"financial_metrics": 62, "financial_engineering": 70, "tech_adoption": 88, "strategic_transformation": 78, "management_stake": 72, "ownership_structure": 65, "culture_purpose": 75, "progressive_practices": 80, "macro_environment": 60, "market_dynamics": 65},
    },
    "FIN": {
        "fundamentals": {"pe": 12, "pb": 1.4, "currentRatio": None, "epsCagr": 7, "divYield": 3.2, "shareholderYield": 5.5, "debtEquity": None},
        "dims": {"financial_metrics": 70, "financial_engineering": 62, "tech_adoption": 55, "strategic_transformation": 55, "management_stake": 60, "ownership_structure": 62, "culture_purpose": 55, "progressive_practices": 55, "macro_environment": 50, "market_dynamics": 55},
    },
    "HC": {
        "fundamentals": {"pe": 24, "pb": 4.2, "currentRatio": 1.9, "epsCagr": 9, "divYield": 1.8, "shareholderYield": 3.0, "debtEquity": 0.6},
        "dims": {"financial_metrics": 72, "financial_engineering": 68, "tech_adoption": 62, "strategic_transformation": 62, "management_stake": 58, "ownership_structure": 60, "culture_purpose": 70, "progressive_practices": 65, "macro_environment": 72, "market_dynamics": 60},
    },
    "CONS_C": {
        "fundamentals": {"pe": 22, "pb": 4.0, "currentRatio": 1.4, "epsCagr": 8, "divYield": 1.4, "shareholderYield": 2.8, "debtEquity": 0.7},
        "dims": {"financial_metrics": 60, "financial_engineering": 62, "tech_adoption": 60, "strategic_transformation": 62, "management_stake": 55, "ownership_structure": 55, "culture_purpose": 62, "progressive_practices": 60, "macro_environment": 50, "market_dynamics": 55},
    },
    "CONS_D": {
        "fundamentals": {"pe": 21, "pb": 5.5, "currentRatio": 1.2, "epsCagr": 6, "divYield": 2.6, "shareholderYield": 4.5, "debtEquity": 0.8},
        "dims": {"financial_metrics": 75, "financial_engineering": 70, "tech_adoption": 55, "strategic_transformation": 55, "management_stake": 55, "ownership_structure": 60, "culture_purpose": 68, "progressive_practices": 58, "macro_environment": 75, "market_dynamics": 55},
    },
    "ENERGY": {
        "fundamentals": {"pe": 11, "pb": 1.8, "currentRatio": 1.4, "epsCagr": 5, "divYield": 4.0, "shareholderYield": 7.0, "debtEquity": 0.5},
        "dims": {"financial_metrics": 62, "financial_engineering": 60, "tech_adoption": 48, "strategic_transformation": 50, "management_stake": 55, "ownership_structure": 55, "culture_purpose": 50, "progressive_practices": 48, "macro_environment": 45, "market_dynamics": 55},
    },
    "INDUS": {
    ...
    "MAT": {
        ...
        "dims": {"financial_metrics": 62, "financial_engineering": 58, "tech_adoption": 50, "strategic_transformation": 55, "management_stake": 55, "ownership_structure": 55, "culture_purpose": 55, "progressive_practices": 52, "macro_environment": 50, "market_dynamics": 55},
    },
    "COMM": {
        "fundamentals": {"pe": 23, "pb": 3.8, "currentRatio": 1.3, "epsCagr": 8, "divYield": 2.0, "shareholderYield": 3.5, "debtEquity": 1.1},
        "dims": {"financial_metrics": 60, "financial_engineering": 62, "tech_adoption": 75, "strategic_transformation": 65, "management_stake": 62, "ownership_structure": 58, "culture_purpose": 62, "progressive_practices": 65, "macro_environment": 60, "market_dynamics": 60},
    },
    "UTIL": {
        "fundamentals": {"pe": 18, "pb": 1.9, "currentRatio": 1.0, "epsCagr": 4, "divYield": 3.6, "shareholderYield": 3.8, "debtEquity": 1.4},
        "dims": {"financial_metrics": 68, "financial_engineering": 60, "tech_adoption": 50, "strategic_transformation": 50, "management_stake": 52, "ownership_structure": 55, "culture_purpose": 60, "progressive_practices": 55, "macro_environment": 75, "market_dynamics": 50},
    },
    "RE": {
        "fundamentals": {"pe": 30, "pb": 2.1, "currentRatio": 1.1, "epsCagr": 5, "divYield": 4.2, "shareholderYield": 4.5, "debtEquity": 1.2},
        "dims": {"financial_metrics": 62, "financial_engineering": 60, "tech_adoption": 50, "strategic_transformation": 55, "management_stake": 58, "ownership_structure": 60, "culture_purpose": 58, "progressive_practices": 55, "macro_environment": 55, "market_dynamics": 50},
    },
    "ETF": {
...
def coverage_report(scored_panel: pd.DataFrame) -> pd.DataFrame:
    """For each dimension, how many rows had it as data-driven (vs baseline)?

    Uses the explicit data_driven_set column (built by score_panel above)
    rather than the std-dev proxy from the old implementation.
    """
    ...
    for dim in DIMENSIONS:
        ...
        rows.append({
            "dimension": dim,
            "n_data_driven": int(live),
            "pct_data_driven": round(100 * live / n, 1) if n else 0.0,
